        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="space-y-4 md:col-span-1">
            ...
            <p className="text-slate-400 text-sm leading-relaxed">
              General construction, remodeling, roofing, flooring, drywall, painting & carpentry services. Request quotes, view project estimates, and receive digital receipts.
            </p>
            <div className="pt-2 text-xs text-slate-500">
              © {new Date().getFullYear()} H-A Construction Inc. All rights reserved.
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm text-slate-400">
              ...
              <li>
                <Link to="/services" className="hover:text-white transition-colors">Services & Quotes</Link>
              </li>
              <li>
                <Link to="/pricing" className="hover:text-white transition-colors font-semibold text-blue-300">Estimates & Pricing</Link>
              </li>
              <li>
          ...
          <div>
            <h4 className="text-xs font-bold uppercase tracking-wider text-blue-400 mb-4">For Partners</h4>
            <ul className="space-y-2.5 text-sm text-slate-400">
              <li>
                <Link to="/join" className="hover:text-white transition-colors font-medium">Join Partner Network</Link>
              </li>
              <li>
                <Link to="/admin/login" className="hover:text-white transition-colors">Contractor Portal Login</Link>
              </li>
              <li>
                <Link to="/about" className="hover:text-white transition-colors">About H-A Construction</Link>
              </li>
              <li>
                <Link to="/blog" className="hover:text-white transition-colors">Construction Blog</Link>
              </li>
            </ul>
          </div>
