...
"[project]/src/pages/admin/AdminLogin.tsx [ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
[__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$admin$2d$auth$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$externals$5d2f$framer$2d$motion__$5b$external$5d$__$28$framer$2d$motion$2c$__esm_import$2c$__$5b$project$5d2f$node_modules$2f$framer$2d$motion$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
;
...
const AdminLogin = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useEffect"])(()=>{
        let active = true;
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$admin$2d$auth$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["fetchAdminSession"])().then((session)=>{
            if (!active) return;
            if (session?.email) {
                navigate("/admin", {
                    replace: true
    ...
    const handleSubmit = async (e)=>{
        e.preventDefault();
        setError("");
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$admin$2d$auth$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["fetchAdminSession"])();
        ...
        const loginResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$admin$2d$auth$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["adminLogin"])();
        if (!loginResult.ok) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4e95b86e._.js.map