...
"[project]/src/lib/navigation-compat.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/portfolio-api.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const fetchPortfolioPublic = async ()=>{
    if (!__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"]) return null;
    try {
        const [catsRes, itemsRes] = await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("portfolio_categories").select("name").order("sortOrder"),
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("portfolio_items").select("*").order("sortOrder")
        ]);
...
const savePortfolioAdmin = async (payload)=>{
    ...
    await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("portfolio_categories").delete().neq("name", "___FORCE_DELETE_ALL___");
    await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("portfolio_categories").insert(categories);
    // 2. Update items
    ...
    await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("portfolio_items").delete().neq("id", "___FORCE_DELETE_ALL___");
    await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("portfolio_items").insert(items);
    return payload;
};
}),
...
"[project]/src/lib/site-settings.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const fetchSiteSettingsPublic = async ()=>{
    if (!__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"]) return defaultSiteSettings;
    try {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("site_settings").select("*");
...
const saveSiteSettingsAdmin = async (payload)=>{
    ...
    const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("site_settings").upsert(rows);
    if (error) throw error;
    return payload;
};
}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__213f2d33._.js.map