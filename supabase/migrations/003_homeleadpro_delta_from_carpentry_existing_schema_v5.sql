-- 003_homeleadpro_delta_from_carpentry_existing_schema_v5.sql
-- Delta Migration to safely adapt the existing Carpentry schema to the HomeLeadPro v2 design (Version 5).
...
--------------------------------------------------------------------------------
-- 🛡️ 1.2. ENSURE PRE-EXISTING TABLES HAVE EXPECTED COLUMNS
--------------------------------------------------------------------------------
