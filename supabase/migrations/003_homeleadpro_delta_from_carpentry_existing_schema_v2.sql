-- 003_homeleadpro_delta_from_carpentry_existing_schema_v2.sql
-- Delta Migration to safely adapt the existing Carpentry schema to the HomeLeadPro v2 design (Corrected Version).
...
begin
    ...
    -- Make reviews.user_id optional (drop not null constraint) if not already optional
...
-- Refer to 001_homeleadpro_rls_draft_v2.sql for full policy details.
